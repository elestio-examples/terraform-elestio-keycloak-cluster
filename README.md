...
| Name | Description |
|------|-------------|
| <a name="output_keycloak_admin"></a> [keycloak\_admin](#output\_keycloak\_admin) | The URL and secrets to connect to Keycloak Admin on each nodes |
| <a name="output_keycloak_database"></a> [keycloak\_database](#output\_keycloak\_database) | This is the database information if you let the module create one for you (`postgres = null` in the config) |
